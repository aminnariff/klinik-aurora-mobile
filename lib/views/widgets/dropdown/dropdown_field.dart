...
import 'package:klinik_aurora_mobile/views/widgets/dropdown/dropdown_attribute.dart';
import 'package:klinik_aurora_mobile/views/widgets/extension/string.dart';
        ...
        DropdownButtonHideUnderline(
          child: DropdownButton2<DropdownAttribute?>(
            ...
            items: widget.attributeList.items
                .map((item) => DropdownMenuItem<DropdownAttribute>(
                      value: item,
                      child: Text(
